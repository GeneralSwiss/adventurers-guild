...
impl EntryId {
    ...
    /// Rejects candidates that could not name an entry.
    ///
    ...
    /// [`EntryId`] without passing through it.
    fn validate(candidate: &str) -> Result<(), InvalidEntryId> {
        ...
        {
            Some(found) => Err(InvalidEntryId::IllegalCharacter {
